import type { NewProduct, Product, ProductCategory } from '@database/types/schema'
...
export const getProductsByCategory = (categoryId: ProductCategory['id']) =>
	db.selectFrom('products').where('categoryId', '=', categoryId).selectAll().execute()
...
export const getProductCategories = () => db.selectFrom('product_categories').selectAll().execute()
